...
function createDeployer(_a) {
    var web3 = _a.web3;
    var _web3 = web3;
    var deployer = {
        setWeb3: function (newWeb3) {
            _web3 = newWeb3;
            return _web3;
        },
        getWeb3: function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, new _web3.eth.Contract(abi)
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, new _web3.eth.Contract(abi, address)];
                        case 2:
                            contract = _a.sent();
                            return [2 /*return*/, contract];
                        case 3:
...
exports.default = createDeployer;
