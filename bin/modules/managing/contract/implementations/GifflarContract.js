...
var GifflarContract = /** @class */ (function () {
    function GifflarContract(compiler, contractWriter, contractModel, deployer) {
        this.compiler = compiler;
        this.contractWriter = contractWriter;
        this.contractModel = contractModel;
        this.deployer = deployer;
    }
    GifflarContract.prototype.execute = function (contractName) {
        var _this = this;
    ...
    GifflarContract = __decorate([
        (0, tsyringe_1.injectable)(),
        __param(0, (0, tsyringe_1.inject)("Compiler")),
        __param(1, (0, tsyringe_1.inject)("ContractWriter")),
        __param(2, (0, tsyringe_1.inject)("ContractModel")),
        __param(3, (0, tsyringe_1.inject)("Deployer")),
        __metadata("design:paramtypes", [Object, Object, Object, Object])
    ], GifflarContract);
    return GifflarContract;
}());
exports.default = GifflarContract;
