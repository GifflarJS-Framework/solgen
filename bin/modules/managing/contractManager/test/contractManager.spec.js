...
describe("Contract Manager Writer", function () {
    var gContractManager = tsyringe_1.container.resolve("GifflarContractManager");
    gContractManager.setWeb3(web3);
    it("Writing Contract Manager", function () {
        ...
        gContractController
            ...
            .endIf();
        var resultJson = gContractManager.contracts.map(function (contract) {
